...
$args = array(
	...
	'tax_query' => array(
		array(
			...
			'field' => 'tag_ID',
			'terms' => '22' // term id (id of the media category)
		)
	)
);
    ...
    <div class="col-md-4">
      <div class="site-main">
        ...
        <?php
                	...
                	?>
        <a class="more-articles" href="/pilier_public/"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Tous les articles...</a> </div>
